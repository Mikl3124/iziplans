...
<body style="font-family: 'Roboto', sans-serif;color:#353b48;">
    <table with="100%" style="max-width:650px;display:block;margin:auto;">
        ...
        <tr style="text-align:center">
            <td width="100%"><a href="https://preprod.iziplans/projet/{{$projet->id}}" style="padding:15px;width:150px;text-align:center;border-radius:3px;color:white;font-weight: bold;text-decoration:none;background-color:#0072ff;font-size:20px;">Accéder au projet</a></td>
        </tr>
    </table>
</body>
</html>
