                ...
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Bonjour Mickaël,</p>
                        <p>Un nouveau projet a été posté sur iziplans:</p>
                        <ul>
                          <li>Par: {{ $user->email }}</li>
                          <li>Titre: {{ $projet->title }}</li>
                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="https://iziplans.com" target="_blank">Aller sur iziplans</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
